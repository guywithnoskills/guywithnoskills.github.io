...
export default function WorkfolioPage() {
  ...
  return (
    <div className={`min-h-screen ${theme.bg} text-white relative`}>
      {/* Background Effects */}
      <div className="absolute inset-0">
        <div className={`absolute inset-0 bg-gradient-to-br ${theme.gradientFrom} ${theme.gradientTo} opacity-80`}></div>
      ...
      <div className="relative z-10">
        ...
        <div className="px-6 md:px-8 pb-8" ref={contentRef}>
          <div className={`${theme.cardBg} rounded-xl p-6 md:p-8 animate-tabSlideIn card-glow-green`}>
